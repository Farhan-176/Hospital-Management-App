  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-blue-100 to-indigo-100 p-0 lg:p-4 relative overflow-hidden">
      ...
      <main className="w-full max-w-6xl h-[95vh] lg:h-[90vh] bg-white shadow-2xl overflow-hidden flex flex-col lg:flex-row lg:rounded-2xl">
        {/* Branded Sidebar */}
        <aside className="w-full lg:w-2/5 bg-gradient-to-br from-primary-600 to-primary-700 p-6 lg:p-7 text-white flex flex-col justify-between relative overflow-hidden">
          {/* Decorative Patterns */}
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3 p-3 bg-white/10 rounded-xl backdrop-blur-sm border border-white/10 hover:bg-white/15 transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-100 italic">Secure access to history anytime.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-white/10 rounded-xl backdrop-blur-sm border border-white/10 hover:bg-white/15 transition-all duration-300">
                ...
                <div>
                  <h3 className="font-bold text-base mb-0.5">Instant Updates</h3>
                  <p className="text-xs text-blue-100 italic">Get real-time alerts instantly.</p>
                </div>
              </div>
            </div>
          </div>
